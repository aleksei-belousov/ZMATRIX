/********** GENERATED on 09/13/2023 at 08:53:06 by CB9980000024**************/
 @OData.entitySet.name: 'ZC_SIZEHEAD_005' 
 @OData.entityType.name: 'ZC_SIZEHEAD_005Type' 

/*+[hideWarning] { "IDS" : [ "CARDINALITY_CHECK" ] }*/
 define root abstract entity ZRAP_ZC_SIZEHEAD_005 { 
...
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _Matrix1 : association [1] to ZRAP_ZC_MATRIX_005 on 1 = 1; 
 } 
